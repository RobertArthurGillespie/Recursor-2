...
public static class HintDependenceModelTrainer
{
    ...
    public static void Train(string csvPath, string modelOutputPath)
    {
        ...
        Console.WriteLine($"[HintDependenceModelTrainer] Loading data from: {csvPath}");
        ...
        Console.WriteLine($"[HintDependenceModelTrainer] Parsed rows: {rows.Count}");
        ...
        Console.WriteLine($"[HintDependenceModelTrainer] LabelHintDependence TRUE rows:  {trueCount}");
        Console.WriteLine($"[HintDependenceModelTrainer] LabelHintDependence FALSE rows: {falseCount}");
        ...
        Console.WriteLine($"[HintDependenceModelTrainer] Train rows: {trainRows}");
        Console.WriteLine($"[HintDependenceModelTrainer] Test rows:  {testRows}");
        ...
        Console.WriteLine("[HintDependenceModelTrainer] Training...");
        var model = pipeline.Fit(split.TrainSet);

        Console.WriteLine("[HintDependenceModelTrainer] Evaluating on test set...");
        ...
        Console.WriteLine($"[HintDependenceModelTrainer] Model saved to: {modelOutputPath}");
    }
}